...
SERVICE=hasher
docker build --file ${SERVICE}/Dockerfile --tag ${DOCKERHUB_USERNAME}/${GITHUB_PROJECT}:${GITHUB_RELEASE}-${SERVICE} ${SERVICE}/
docker push ${DOCKERHUB_USERNAME}/${GITHUB_PROJECT}:${GITHUB_RELEASE}-${SERVICE}
